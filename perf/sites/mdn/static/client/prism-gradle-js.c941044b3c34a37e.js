export const __rspack_esm_id = 3855;
export const __rspack_esm_ids = [3855];
export const __webpack_modules__ = {
  43523() {
    ...
    ((n = {
      ...
      ((e = Prism).languages.gradle = e.languages.extend('clike', {
        string: {
          pattern: /'''(?:[^\\]|\\[\s\S])*?'''|'(?:\\.|[^\\'\r\n])*'/,
          greedy: !0
        },
...
//# sourceMappingURL=prism-gradle-js.c941044b3c34a37e.js.map
