export const __rspack_esm_id = 9319;
export const __rspack_esm_ids = [9319];
export const __webpack_modules__ = {
  61507() {
    ...
    ((e = Prism),
      ...
      (r = function (e) {
        return RegExp('(^|\\s)(?:' + e.map(n).join('|') + ')(?=\\s|$)');
      }),
      Object.keys(
        (a = {
          'kernel-builtin': [
...
//# sourceMappingURL=prism-factor-js.50d9933fb843f6dc.js.map
