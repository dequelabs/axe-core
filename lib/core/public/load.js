      ...
      return runRules(
        ...
        (results, cleanupFn) => {
          ...
          results = results.map(rawResult => ({
            ...rawResult,
            passes: nodeSerializer.mapRawNodeResults(rawResult.passes),
            incomplete: nodeSerializer.mapRawNodeResults(rawResult.incomplete),
            violations: nodeSerializer.mapRawNodeResults(rawResult.violations)
          }));
          resolve(results);
