/*global Audit, runRules, cleanupPlugins, resetConfiguration, configureChecksRulesAndBranding */
function runCommand(data, keepalive, callback) {
	...
	switch (data.command) {
		...
		case 'reset':
			return resetConfiguration(resolve, reject);
		case 'configure':
			return configureChecksRulesAndBranding(data.spec, callback);
		default:
