 ...
 * @property {Function} toSpec Converts an Element or VirtualNode to a "spec", a form
...
Object.assign(nodeSerializer, {
  ...
  combineSpecs(nodeSpec, parentFrameSpec) {
    if (typeof serializer?.combineSpecs === 'function') {
      return serializer.combineSpecs(nodeSpec, parentFrameSpec);
    }
