...
import aggregateChecks from './aggregateChecks';
...
import collectResultsFromFrames, {
	sendCommandToFrame
...
import { getFlattenedTree, getNodeFromTree } from './flattened-tree';
...
import parseCrossOriginStylesheet from './parse-sameorigin-stylesheet';
...
import { querySelectorAll, querySelectorAllFilter } from './qsa';
import queue from './queue';
import respondable from './respondable';
import ruleShouldRun from './rule-should-run';
import { getScrollState, setScrollState } from './scroll-state';
import select from './select';
import toArray, { uniqueArray } from './to-array';
...
var utils = (axe.utils = {
	...
	toArray,
	tokenList,
	uuid, // TODO: this is not part of the public API. Remove from here.
	validInputTypes,
	validLangs
});
