	...
	return {
		...
		isFocusable: function() {
			if (!this._isFocusable) {
				this._isFocusable = axe.commons.dom.isFocusable(node);
			}
			return this._isFocusable;
		},
		tabbableElements: function() {
			if (!this._tabbableElements) {
				this._tabbableElements = axe.commons.dom.getTabbableElements(this);
			}
