 ...
 */
export default function isHidden(el, recursed) {
  ...
  if (el.nodeName.toLowerCase() === 'details' && isDetailsHidden(el)) {
    return true;
  }
 ...
 * @retruns {boolean}
 */
function isDetailsHidden(el) {
  // Handle lack of support in IE
