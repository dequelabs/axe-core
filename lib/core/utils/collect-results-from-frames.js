...
function collectResultsFromFrames(
  ...
  frames.forEach(frame => {
    const tabindex = frame.node.getAttribute('tabindex');
    const focusable = tabindex ? parseInt(tabindex) >= 0 : true;
    ...
    var params = {
      ...
      context: {
        ...
        // iframe stack is not focusable
        focusable: context.focusable === false ? false : focusable,
        page: context.page,
