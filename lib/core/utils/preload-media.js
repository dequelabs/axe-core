...
function isMediaElementReady(elm) {
  return new Promise((resolve, reject) => {
    console.log('elm.readyState:', elm.readyState);
    /**
    ...
    function onError() {
      elm.removeEventListener('error', onError);
      reject('Error ' + elm.error.code + '; details: ' + elm.error.message);
    }
    ...
    elm.addEventListener('error', onError);
  });
}
