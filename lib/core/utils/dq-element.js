...
const DqElement = memoize(function DqElement(elm, options, spec) {
  ...
  if (typeof options.selectors === 'object') {
    Object.assign(this._options, options.selectors);
  }
 ...
 * @property {boolean|object} selectors Selector configuration
 */
DqElement.setRunOptions = function setRunOptions({
  ...
  cache.set(CACHE_KEY, { elementRef, absolutePaths, selectors });
};
