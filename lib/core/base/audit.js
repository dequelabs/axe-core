/*global Rule, Tool, Listener, Check, injectStyle, commons: true */
...
function Audit(audit) {
	...
	unpackToObject(audit.finders, this, 'addFinder');
	unpackToObject(audit.listeners, this, 'addListener');
...
/**
 * Adds a new finder to the Audit.  If a finder with specified ID already exists, it will be overridden
 * @param {Object} spec Tool specification object
 */
Audit.prototype.addFinder = function (spec) {
	'use strict';
	this.finders[spec.id] = new Tool(spec);
};

/**
 * Adds a new listener to the Audit.  If a listener with specified ID already exists, it will be overridden
 * @param {Object} spec Tool specification object
 */
Audit.prototype.addListener = function (spec) {
	'use strict';
	this.listeners[spec.id] = new Listener(spec);
};
