...
// out its name
export {
	default as AbstractVirtualNode
} from './virtual-node/abstract-virtual-node.js';
export {
	default as SerialVirtualNode
} from './virtual-node/serial-virtual-node.js';
export { default as VirtualNode } from './virtual-node/virtual-node.js';
