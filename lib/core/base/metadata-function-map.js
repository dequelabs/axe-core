...
import zoomedTextNotClippedEvaluate from '../../checks/visibility/zoomed-text-not-clipped-evaluate';
...
import zoomedTextNotClippedMatches from '../../rules/zoomed-text-not-clipped-matches';
...
const metadataFunctionMap = {
	...
	'zoomed-text-not-clipped-evaluate': zoomedTextNotClippedEvaluate,
	...
	'zoomed-text-not-clipped-matches': zoomedTextNotClippedMatches
};
