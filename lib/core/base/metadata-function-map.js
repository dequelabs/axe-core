...
import epubTypeHasMatchingRoleMatches from '../../rules/epub-type-has-matching-role-matches';
import pagebreakLabelMatches from '../../rules/pagebreak-label-matches';
import matchingAriaRoleEvaluate from '../../checks/aria/matching-aria-role-evaluate';
...
const metadataFunctionMap = {
  ...
  'epub-type-has-matching-role-matches': epubTypeHasMatchingRoleMatches,
  'pagebreak-label-matches': pagebreakLabelMatches,
  'matching-aria-role-evaluate': matchingAriaRoleEvaluate
};
