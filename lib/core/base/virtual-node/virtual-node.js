...
import { isXHTML, validInputTypes, getElementInternals } from '../../utils';
import { isFocusable, getTabbableElements } from '../../../commons/dom';
import cache from '../cache';

let nodeIndex = 0;

export default class VirtualNode extends AbstractVirtualNode {
  /**
  ...
  toJSON() {
    return { nodeIndex: this.nodeIndex }
  }
  ...
  /**
   * Return the element internals for this element and cache the result.
