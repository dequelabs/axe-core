...
class VirtualNode extends axe.AbstractVirtualNode {
	...
	/**
	 * Return a property of the computed style for this element and cache the result.
	...
	getComputedStylePropertyValue(property) {
		...
		if (!this._cache.hasOwnProperty(key)) {
			this._cache[key] = this.computedStyle.getPropertyValue(property);
		}
	...
	/**
	 * Return the computed style for this element and cache the result.
	...
	get computedStyle() {
		...
		return this._cache.computedStyle;
	}
