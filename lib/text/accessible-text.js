...
/*jshint maxstatements: 35, maxcomplexity: 17 */
...
text.accessibleText = function(element) {
	 ...
	 * @return {string}
	 */
	function getAccessibleText(element, inLabelledByContext, inControlContext) {
		'use strict';
		...
		if (!role ||
			aria.getRolesWithNameFromContents().indexOf(role) !== -1) {
