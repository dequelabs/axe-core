...
lookupTable.role = {
	...
	'option': {
		...
		nameFrom: ['author', 'contents'],
		context: ['listbox'],
		implicit: ['datalist > option', 'optgroup > option', 'select > option']
	},
	'presentation': {
		type: 'structure',
		attributes: null,
...
lookupTables.element = {
	'article': { roles: ['feed', 'presentation', 'none', 'document', 'application', 'main', 'region'] },
	'aside': {
		roles: ['feed', 'note', 'presentation', 'none', 'region', 'search', 'doc-example', 'doc-footnote',
			'doc-pullquote', 'doc-tip']
	},
	'audio': { roles: [ 'application' ] },
	'base': { roles: [] },
	'body': { roles: [] },
	'caption': { roles: [] },
	'col': { roles: [] },
	...
	'dd': { roles: [] },
	'details': { roles: [] },
	'dialog': { roles: [ 'alertdialog' ] },
	'dl': { roles: ['group', 'presentation', 'none', 'doc-glossary'] },
	'dt': { roles: [] },
	'embed': { roles: ['application', 'document', 'presentation', 'none', 'img'] },
	'figcaption': { roles: ['group', 'presentation', 'none'] },
	'fieldset': { roles: ['group', 'presentation', 'none'] },
	'figure': { roles: ['group', 'presentation', 'none'] },
	'footer': {roles: ['group', 'none', 'presentation', 'doc-footnote']},
	'form': { roles: ['search', 'presentation', 'none'] },
	'h1': { roles: ['tab', 'none', 'presentation', 'doc-subtitle'] },
	'h2': { roles: ['tab', 'none', 'presentation', 'doc-subtitle'] },
	'h3': { roles: ['tab', 'none', 'presentation', 'doc-subtitle'] },
	'h4': { roles: ['tab', 'none', 'presentation', 'doc-subtitle'] },
	'h5': { roles: ['tab', 'none', 'presentation', 'doc-subtitle'] },
	'h6': { roles: ['tab', 'none', 'presentation', 'doc-subtitle'] },
	'head': { roles: [] },
	'header': { roles: ['group', 'none', 'presentation', 'doc-footnote'] },
	'hr': { roles: ['presentation', 'doc-pagebreak']},
	'html': { roles: [] },
	'iframe': { roles: ['application', 'document', 'img']},
	'keygen': { roles: [] },
	'label': { roles: [] },
	'legend': { roles: [] },
	'main': { roles: [] },
	...
	'meta': { roles: [] },
	'meter': { roles: [] },
	'nav': { roles: ['doc-index', 'doc-pagelist', 'doc-toc'] },
	'noscript': { roles: [] },
	'object': { roles: ['application', 'document', 'img'] },
	'ol': {
		roles: ['directory', 'group', 'listbox', 'menu', 'menubar', 'none', 'presentation', 'radiogroup',
	...
	'script': { roles: [] },
	'section': {
		roles: ['alert', 'alertdialog', 'application', 'banner', 'complementary', 'contentinfo', 'dialog',
			'document', 'feed', 'log', 'main', 'marquee', 'navigation', 'none', 'presentation', 'search',
			'status', 'tabpanel', 'doc-abstract', 'doc-acknowledgments', 'doc-afterword', 'doc-appendix',
			'doc-bibliography', 'doc-chapter', 'doc-colophon', 'doc-conclusion', 'doc-credit',
			'doc-credits', 'doc-dedication', 'doc-endnotes', 'doc-epilogue', 'doc-errata', 'doc-example',
			'doc-foreword', 'doc-index', 'doc-introduction', 'doc-notice', 'doc-pagelist', 'doc-part',
	...
	'track': { roles: [] },
	'ul': {
		roles: ['directory', 'group', 'listbox', 'menu', 'menubar', 'radiogroup', 'tablist', 'toolbar',
			'tree', 'presentation']
	},
	'video': { roles: ['application']},
	'clipPath': { roles: [] },
	'cursor': { roles: [] },
	'defs': { roles: [] },
	'desc': { roles: [] },
	'feBlend': { roles: [] },
	'feColorMatrix': { roles: [] },
	'feComponentTransfer': { roles: [] },
	'feComposite': { roles: [] },
	'feConvolveMatrix': { roles: [] },
	'feDiffuseLighting': { roles: [] },
	'feDisplacementMap': { roles: [] },
	'feDistantLight': { roles: [] },
	'feDropShadow': { roles: [] },
	'feFlood': { roles: [] },
	'feFuncA': { roles: [] },
	'feFuncB': { roles: [] },
