...
lookupTable.elementsAllowedAnyRole = ['DIV'];

lookupTable.evaluateRoleForElement = {
	// TODO: debate about enhancing allowedElements in role mapping with an evaluate function, but can lead to lots of duplication
	A: ({ node, out }) => {
