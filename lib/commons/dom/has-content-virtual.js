import isVisualContent from './is-visual-content.js';
 ...
 * @return {Boolean}
 */
export function hasContentVirtual(elm, noRecursion, ignoreAria) {
	return (
		// It has text
 ...
 * @return {Boolean}
 */
export function hasContent(elm, noRecursion, ignoreAria) {
