 ...
 */
function isHiddenSelf(vNode, recursed) {
  return vNode.cache.get('isHiddenForEveryone_self', () => {
 ...
 */
function isHiddenAncestors(vNode, recursed) {
  return vNode.cache.get('isHiddenForEveryone_ancestors', () => {
