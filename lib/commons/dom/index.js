...
export { findUp, findUpVirtual } from './find-up-virtual';
...
export { hasContent, hasContentVirtual } from './has-content-virtual';
...
} from './reduce-to-elements-below-floating';
export {
	default as shadowElementsFromPoint
} from './shadow-elements-from-point';
