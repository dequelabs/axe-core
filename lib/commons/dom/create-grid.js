...
class Grid {
   ...
   * @returns {Array<AbstractVirtualNode>|null}
   */
  getCellFromPoint({ x, y }) {
    assert(this.boundary, 'Grid does not have cells added');
   ...
   * @param {(vNode:AbstractVirtualNode, place: { row: number, col: number}): any} callback
   */
