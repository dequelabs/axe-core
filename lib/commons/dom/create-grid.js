...
class Grid {
  ...
  getCellFromPoint({ x, y }) {
    ...
    // Return empty array for out-of-bounds points instead of throwing,
    // so that elements positioned outside the grid (via CSS transforms,
    // negative margins, absolute positioning, etc.) produce an
    // "incomplete" result rather than crashing the audit.
