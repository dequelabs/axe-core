...
function isInTextBlock(node, { noLengthCompare, permissive = false } = {}) {
  ...
  // look at the siblings of the node and if any are inline or text nodes then return
  // the desired permissive option value so the caller determine what to do with them
