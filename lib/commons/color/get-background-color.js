...
/**
 * Get a background color from the background stack mixed on top of white, if one exists
 * @method getBackgroundColor
 * @memberof axe.commons.color
 * @instance
 * @param {Element} elm The node under test
 * @param {Array} bgElms (optional) An array to fill with background stack elements
 * @param {Boolean} noScroll (optional) Prevent scrolling in overflow:hidden containers, defaults to false
 * @return {Color|null}
**/
