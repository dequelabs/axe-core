...
let addToStackingContextStart;
let getOwnBackgroundColorStart;

let getBackgroundStackTime = 0;
let addToStackingContextTime = 0;
...
export function getStackingContext(elm, elmStack) {
  ...
  elmStack.forEach(bgElm => {
    ...
    addToStackingContextStart = window.performance.now();
    ...
    addToStackingContextTime += window.performance.now() - addToStackingContextStart;
...
getStackingContext._logTime = function() {
  performanceTimer._log('Measure runchecks_color-contrast#getBackgroundColor_getStackingContext_getBackgroundStack took ' + getBackgroundStackTime + 'ms');
  performanceTimer._log('Measure runchecks_color-contrast#getBackgroundColor_getStackingContext_getOwnBackgroundColor took ' + getOwnBackgroundColorTime + 'ms');
  performanceTimer._log('Measure runchecks_color-contrast#getBackgroundColor_getStackingContext_addToStackingContext took ' + addToStackingContextTime + 'ms');
}
