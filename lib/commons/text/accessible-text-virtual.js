...
import arialabelText from '../aria/arialabel-text.js';
import nativeTextAlternative from './native-text-alternative,js';
import formControlValue from './form-control-value.js';
import subtreeText from './subtree-text.js';
 ...
 * @return {string}
 */
export function accessibleText(element, context) {
 ...
 * @return {string}
 */
export function accessibleTextVirtual(virtualNode, context = {}) {
