...
import visibleVirtual from './visible-virtual.js';
import accessibleTextVirtual from './accessible-text-virtual.js';
import isNativeTextbox from '../forms/is-native-textbox.js';
import isNativeSelect from '../forms/is-native-select.js';
import isAriaListbox from '../forms/is-aria-listbox.js';
import isAriaTextbox from '../forms/is-aria-textbox.js';
import isAriaCombobox from '../forms/is-aria-combobox.js';
import isAriaRange from '../forms/is-aria-range.js';
import getRole from '../aria/get-role.js';
import getOwnedVirtual from '../aria/get-owned-virtual.js';
import isHiddenWithCSS from '../dom/is-hidden-with-css.js';
 ...
 */
export function formControlValue(virtualNode, context = {}) {
	const { actualNode } = virtualNode;
	const unsupported = unsupported.accessibleNameFromFieldValue || [];
...
function ariaComboboxValue(virtualNode, context) {
	...
	listbox = aria
		...
		.filter(elm => getRole(elm) === 'listbox')[0];

	return listbox
		? formControlValueMethods.ariaListboxValue(listbox, context)
		: '';
}
