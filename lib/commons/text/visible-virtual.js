 ...
 * @param  {Boolean} noRecursing When False, the result will contain text from the element and it's children. When True, the result will only contain text from the element
 * @return {String}
 */
