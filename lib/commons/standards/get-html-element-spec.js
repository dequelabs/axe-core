...
/**
 * Return the spec for an HTML element from the html-elms standard. Since the spec is determined by the node and what attributes it has, a node is required.
 * @param {VirtualNode} vNode The VirtualNode to get the spec for.
 * @return {Object} The html-elms standard spec
 */
function getHtmlElementSpec(vNode) {
...
export default getHtmlElementSpec;
