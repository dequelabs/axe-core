...
function Check(spec) {
	...
	/**
	 * Optional. Impact of the generated issue, e.g. trivial, minor, major, severe
	 * @type {String}
	 */
	this.impact = spec.impact || dqre.constants.impact.MAJOR;

	/**
	 * Optional. The interpretation of the issue - is it a best practice or a violation, default is violation
	 * @type {String}
	 */
	this.interpretation = spec.interpretation || dqre.constants.interpretation.VIOLATION;

	/**
	 * Optional. The certainty with which a check can determine whether there is an issue, can be definite or potential
	 * @type {String}
	 */
	this.certainty = spec.certainty || dqre.constants.certainty.DEFINITE;
	...
	/**
	 * Optional. for page level rules, the after function processes the data to make a decision
	 * @type {Function}
	 */
	if (spec.after) {
