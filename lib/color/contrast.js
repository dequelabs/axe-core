...
color.Color = function (red, green, blue, alpha) {
	...
	this.toHexString = function () {
		var redString = this.red.toString(16);
		var greenString = this.green.toString(16);
		var blueString = this.blue.toString(16);
		return '#' + (this.red > 15 ? redString : '0' + redString) +
			(this.green > 15 ? greenString : '0' + greenString) +
			(this.blue > 15 ? blueString : '0' + blueString);
	};
