...
const ariaRoles = {
	...
	checkbox: {
		...
		// aria-checked=false it is not required to be added by
		// the user
		//
	...
	option: {
		...
		// aria-selected=false it is not required to be added by
		// the user
		allowedAttrs: [
			'aria-selected',
			'aria-checked',
	...
	radio: {
		...
		// aria-check=false it is not required to be added by
		// the user
		//
	...
	scrollbar: {
		type: 'widget',
		// Note: since the scrollbar role has an implicit
		// aria-orientation, aria-valuemax, aria-valuemin, and
		// aria-valuenow it is not required to be added by
		// the user
		//
		// Note: because aria-controls is not well supported we will not
		// make it a required attribute even though it is required in the
	...
	separator: {
		type: 'structure',
		// Note: since the separator role has an implicit
		// aria-orientation, aria-valuemax, aria-valuemin, and
		// aria-valuenow it is not required to be added by
		// the user
		allowedAttrs: [
	...
	slider: {
		type: 'widget',
		// Note: since the slider role has an implicit
		// aria-orientation, aria-valuemax, aria-valuemin, and
		// aria-valuenow it is not required to be added by
		// the user
		allowedAttrs: [
	...
	spinbutton: {
		type: 'widget',
		// Note: since the spinbutton role has an implicit
		// aria-orientation, aria-valuemax, aria-valuemin, and
		// aria-valuenow it is not required to be added by
		// the user
		allowedAttrs: [
