  ...
  input: {
    variant: {
      ...
      placeholderNaming: {
        ...
        // 4.1.1 input type="text", input type="password", input type="number",
        // input type="search", input type="tel", input type="email", input type="url"
      ...
      default: {
        ...
        // 4.1.2+ other input types don't use the placeholder for their name
