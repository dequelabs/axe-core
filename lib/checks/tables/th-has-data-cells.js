 ...
 * @param  {array}    table    A matrix of the table obtained using commons.table.toArray
...
var headers = cells.filter(function (cell) {
	if (commons.text.sanitize(cell.textContent) === '') {
		return false;
	}
