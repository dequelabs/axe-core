...
const getPseudoElementArea = memoize(function hasPseudoElement(node, pseudo) {
  ...
  if (pseudoWidth.unit !== 'px' || pseudoWidth.unit !== 'px') {
    return Infinity; // IE doesn't normalize to px. Infinity gets everything to undefined
  }
