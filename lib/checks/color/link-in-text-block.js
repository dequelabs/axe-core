import linkInTextBlockEvaluate from './link-in-text-block-evaluate';

const linkInTextBlockMetadata = {
	id: 'link-in-text-block',
	evaluate: linkInTextBlockEvaluate,
	metadata: {
		impact: 'serious',
		messages: {
...
export default linkInTextBlockMetadata;