import colorContrastEvaluate from './color-contrast-evaluate';

const colorContrastMetadata = {
	id: 'color-contrast',
	evaluate: colorContrastEvaluate,
	metadata: {
		impact: 'serious',
		messages: {
...
export default colorContrastMetadata;