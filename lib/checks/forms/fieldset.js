...
var matchingNodes = node.ownerDocument.querySelectorAll('input[type=' + node.type + '][name="' + escapedName + '"]');
...
var containsProperFormElements = function (groupParent) {
	var groupNodes = groupParent.querySelectorAll('input[type="' + node.type + '"][name="' + escapedName + '"]');
