import fieldsetEvaluate from './fieldset-evaluate';
import fieldsetAfter from './fieldset-after';

const fieldsetMetadata = {
	id: 'fieldset',
	evaluate: fieldsetEvaluate,
	after: fieldsetAfter,
	deprecated: true,
	metadata: {
		impact: 'critical',
...
export default fieldsetMetadata;