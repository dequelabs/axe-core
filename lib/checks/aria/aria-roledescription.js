import ariaRoledescriptionEvaluate from './aria-roledescription-evaluate';

const ariaRoledescriptionMetadata = {
	id: 'aria-roledescription',
	evaluate: ariaRoledescriptionEvaluate,
	options: {
		supportedRoles: [
			'button',
			'img',
...
export default ariaRoledescriptionMetadata;
