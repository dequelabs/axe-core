...
function ariaAllowedAttrEvaluate(node, options, virtualNode) {
  ...
  const tableRole = closest(virtualNode, 'div[role="table"]')
    ? closest(virtualNode, 'div[role="table"]').actualNode.attributes.role.value
    : null;
  const gridRole = closest(virtualNode, 'div[role="grid"]')
    ? closest(virtualNode, 'div[role="grid"]').actualNode.attributes.role.value
    : null;
