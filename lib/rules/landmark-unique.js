import landmarkUniqueMatches from './landmark-unique-matches';

const landmarkUniqueMetadata = {
	id: 'landmark-unique',
	...
	matches: landmarkUniqueMatches,
	all: [],
	any: ['landmark-is-unique'],
	none: []
};

export default landmarkUniqueMetadata;