import ariaDpubRoleFallbackMatches from './aria-dpub-role-fallback-matches';

const ariaDpubRoleFallbackMetadata = {
	id: 'aria-dpub-role-fallback',
	selector: '[role]',
	matches: ariaDpubRoleFallbackMatches,
...
export default ariaDpubRoleFallbackMetadata;