describe('color-contrast code highlighting test', function() {
  ...
  describe('violations', function() {
    it('should find issues', function() {
      ...
      assert.lengthOf(results.violations[0].nodes, 33);
      assert.lengthOf(results.violations[1].nodes, 32);
    });
  });
  ...
  describe('passes', function() {
    it('should find passes', function() {
      ...
      assert.lengthOf(results.passes[0].nodes, 26);
      assert.lengthOf(results.passes[1].nodes, 27);
    });
  });
