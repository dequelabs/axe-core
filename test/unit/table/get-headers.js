describe('table.getHeaders', function () {
	...
	it('should work with scope=auto', function () {
		...
		assert.deepEqual(kslib.table.getHeaders(target), [$id('t1'), $id('t2')]);
	});
	...
	it('should find multiple column headers', function () {
		...
		assert.deepEqual(kslib.table.getHeaders(target), [$id('t1'), $id('t2'), $id('t3')]);
	});
	...
	it('should handle colspans', function () {
		...
		assert.deepEqual(kslib.table.getHeaders(target), [$id('t1')]);
	});
