describe('reporters - na', () => {
  ...
  it('should merge the runRules results into violations, passes and inapplicable', () => {
    axe.getReporter('na')(runResults, {}, results => {
