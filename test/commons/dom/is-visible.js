describe('dom.isVisible', function () {
  ...
  describe('default usage', function () {
    ...
    describe('details', function () {
      it('should return true for element in open details', function () {
        fixture.innerHTML =
          '<details open>' +
      ...
      (isIE11 ? xit : it)(
        'should return false for element in closed details',
        function () {
          fixture.innerHTML =
            '<details>' +
            '<summary>Summary node</summary>' +
      ...
      (isIE11 ? xit : it)(
        'should return true for summary element in closed details',
        function () {
          fixture.innerHTML =
            '<details>' +
      ...
      it('should return false for hidden summary element in open details', function () {
        fixture.innerHTML =
          '<details open>' +
      ...
      it('should return false for hidden summary element in closed details', function () {
        fixture.innerHTML =
          '<details>' +
          '<summary id="target" style="display: none">Summary node</summary>' +
          '<div>Hello World</div>';
