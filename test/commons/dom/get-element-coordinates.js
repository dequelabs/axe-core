...
describe('dom.getElementCoordinates', () => {
  ...
  it('should calculate bounding box based on element position', () => {
    let el, coords;
    ...
    fixture.innerHTML = html`
      <div id="div" style="position: absolute; top: -1px; left: -1px;">
        <span
          id="coords0"
          style="position:absolute; top: -999px; left: -999px; width: 1000px; height: 1000px;"
        >
          Absolute</span
        >
      </div>
  ...
  it('should take into account scroll offsets', () => {
    let el;
    let coords;
    const offset = axe.commons.dom.getScrollOffset(window.document);
