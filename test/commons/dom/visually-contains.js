describe('dom.visuallyContains', function () {
  ...
  it('should return false when overflow is hidden', function () {
    ...
    let result = axe.commons.dom.visuallyContains(
      target.actualNode,
      target.parent.actualNode
    );
  ...
  it('should return true when element is contained by scroll region', function () {
    ...
    let result = axe.commons.dom.visuallyContains(target.actualNode, parent);
  ...
  (shadowSupported ? it : xit)(
    ...
    function () {
      ...
      let result = axe.commons.dom.visuallyContains(target, container);
      assert.isTrue(result);
    }
  );
  ...
  (shadowSupported ? it : xit)(
    ...
    function () {
      ...
      let target = shadow.querySelector('#target');
      let parent = fixture.querySelector('#parent');
      let result = axe.commons.dom.visuallyContains(target, parent);
      assert.isTrue(result);
    }
  );
