  ...
  describe('stack order', () => {
    ...
    it('should return stack in DOM order of non-positioned elements with z-index', () => {
      fixture.innerHTML = html`
        <div id="1" style=";width:40px;height:40px;">
          <div id="target" style="width:40px;height:40px;z-index:100">
            hello world
          </div>
        </div>
    ...
    it('should handle z-index positioned elements in the same stacking context', () => {
      ...
      fixture.innerHTML = html`
        <div id="target" style="width:40px;height:40px;position:relative;">
          <br />DIV #1 <br />position:relative;
          <div
            id="2"
            style="width:40px;height:40px;position:absolute;top:0;z-index:1;"
          >
            <br />DIV #2 <br />position:absolute; <br />z-index:1;
          </div>
        </div>
        <br />
        <div
          id="3"
          style="width:40px;height:40px;position:relative;    margin-top:-58px;"
        >
          <br />DIV #3 <br />position:relative;
          <div
            id="4"
            style="width:40px;height:40px;position:absolute;top:0;z-index:2;"
          >
            <br />DIV #4 <br />position:absolute; <br />z-index:2;
          </div>
        </div>
      `;
      axe.testUtils.flatTreeSetup(fixture);
      ...
      fixture.innerHTML = html`
        <div id="target" style="width:40px;height:40px;position:relative;">
          ...
          <div
            ...
            style="width:40px;height:40px;position:absolute;top:0;z-index:2;"
          >
            <br />DIV #2 <br />position:absolute; <br />z-index:2;
          </div>
        </div>
        <br />
        <div
          id="3"
          style="width:40px;height:40px;position:relative;    margin-top:-58px;z-index:1"
        >
          <br />DIV #3 <br />position:relative;
          <div
            id="4"
            style="width:40px;height:40px;position:absolute;top:0;z-index:10;"
          >
            <br />DIV #4 <br />position:absolute; <br />z-index:10;
          </div>
        </div>
      `;
      axe.testUtils.flatTreeSetup(fixture);
    ...
    it('should handle complex stacking context', () => {
      ...
      fixture.innerHTML = html`
        <div
          id="1"
          style="position:absolute;top:0;left:0;width:40px;height:40px;z-index:5;"
        >
        ...
        <div
          id="2"
          style="position:absolute;top:0;left:0;width:40px;height:40px;z-index:2;"
        >
        ...
        <div
          id="3"
          style="position:absolute;top:0;left:0;width:40px;height:40px;z-index:4;"
        >
          <div
            id="4"
            style="position:absolute;top:0;left:0;width:40px;height:40px;z-index:6;"
          >
          ...
          <div
            id="target"
            style="position:absolute;top:0;left:0;width:40px;height:40px;z-index:3;"
          >
    ...
    ['flex', 'inline-flex', 'grid', 'inline-grid'].forEach(type => {
      it(`should correctly order "${type}" items with z-index`, () => {
        fixture.innerHTML = html`
          <div
            id="1"
            style="position:absolute;width:40px;height:40px;z-index:1"
          ></div>
    ...
    it('should handle modals on top of the stack', () => {
      fixture.innerHTML = html`
        ...
        <div
          id="3"
          style="position:absolute;top:0;left:0;right:0;height:100px"
        ></div>
      `;
      axe.testUtils.flatTreeSetup(fixture);
      const target = fixture.querySelector('#target');
    ...
    it('should handle "pointer-events:none"', () => {
      fixture.innerHTML = html`
        ...
        <div
          id="3"
          style="position:absolute;top:0;left:0;right:0;height:100px;pointer-events:none"
        ></div>
      `;
      axe.testUtils.flatTreeSetup(fixture);
      const target = fixture.querySelector('#target');
    ...
    it('should not return elements that do not fully cover the target', () => {
      fixture.innerHTML = html`
        <div id="1" style="position:relative;">
          ...
          <p
            id="target"
            style="position:relative;z-index:1;width:300px;height:40px;"
          >
    ...
    it('should return elements that partially cover the target', () => {
      fixture.innerHTML = html`
        <div id="1" style="height:40px;position:relative;">
          ...
          <div id="target" style="position:absolute;margin-top:-11px;">
            Text
          </div>
        </div>
      `;
    ...
    it('should not add hidden elements', () => {
      fixture.innerHTML = html`
        <main id="1">
          ...
          <div id="3" style="position: absolute; visibility: hidden">
            Some text
          </div>
    ...
    it('should correctly position siblings with positioned children correctly', () => {
      fixture.innerHTML = html`
        ...
        <div id="3" style="position: absolute; top: 0; left: 0;">
          <div id="4" style="position: absolute; top: 0; left: 0;">
            Some text
          </div>
          <div id="5">
      ...
      fixture.innerHTML = html`
        <div id="1" style="width: 50px; height: 50px; position: relative;">
          <div id="2" style="width: 50px; height: 50px; float: left;">
            ...
            <div
              id="5"
              style="width: 50px; height: 50px; position: absolute; top:0"
            ></div>
          </div>
        </div>
      `;
      ...
      fixture.innerHTML = html`
        ...
        <div id="3" style="opacity: 0.8;">
          <div id="4" style="position: absolute; top: 20px; z-index: -1;">
            <div
              id="5"
              style="height: 40px; width: 100vw; background: red"
            ></div>
          </div>
        </div>
      `;
    ...
    it('should correctly position children of different stacking contexts', () => {
      fixture.innerHTML = html`
        <header
          id="1"
          style="position: absolute; z-index: 999; height: 50px; width: 100%; top: 0"
        >
          ...
          <div
            id="4"
            style="display: flex; position: absolute; height: 50px; width: 100%; top: 0;"
          >
            <div
              id="5"
    ...
    it('should sort shadow dom elements correctly', () => {
    ...
    it('should sort nested shadow dom elements correctly', () => {
      fixture.innerHTML = '<div id="container"></div>';
      const container = fixture.querySelector('#container');
      const shadow = container.attachShadow({ mode: 'open' });
    ...
    it('should sort positioned shadow elements correctly', () => {
      fixture.innerHTML = '<div id="container"></div>';
      const container = fixture.querySelector('#container');
      const shadow = container.attachShadow({ mode: 'open' });
    ...
    it('should sort shadow elements with different trees correctly', () => {
      fixture.innerHTML =
