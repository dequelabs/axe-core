describe('table.getHeaders', () => {
  ...
  it('should work with scope=auto', () => {
  ...
  it('should work with scope set', () => {
    fixture.innerHTML = html`
      <table>
        <tr>
          <td></td>
          <th scope="col" id="t1">1</th>
          <th scope="col">2</th>
        </tr>
        <tr>
          <th scope="row" id="t2">1</th>
          <td id="target">ok</td>
          <td></td>
        </tr>
      </table>
  ...
  it('should find multiple column headers', () => {
    fixture.innerHTML = html`
      <table>
        <tr>
          <td></td>
        ...
        <tr>
          <td></td>
          <th scope="col" id="t2">1</th>
          <th scope="col">2</th>
        </tr>
        <tr>
          <th scope="row" id="t3">1</th>
          <td id="target">ok</td>
          <td></td>
        </tr>
      </table>
  ...
  it('should find multiple row headers', () => {
    fixture.innerHTML = html`
      <table>
        <tr>
          <td></td>
          <th scope="col">1</th>
          <th scope="col" id="t1">2</th>
        </tr>
        <tr>
          <th scope="row" id="t2">1</th>
          <th scope="row" id="t3">2</th>
          <td id="target">ok</td>
        </tr>
      </table>
    `;
  ...
  it('should handle headers attribute', () => {
    fixture.innerHTML = html`
      <table>
        <tr>
          <td id="t1">t1</td>
        ...
        <tr>
          <td id="t3">t3</td>
          <td id="target" headers="t1 t2 t3"></td>
        </tr>
      </table>
    `;
  ...
  it('should handle empty headers attribute', () => {
    fixture.innerHTML = html`
      <table>
        <tr>
  ...
  it('should handle non-existent headers attribute', () => {
    fixture.innerHTML = html`
      <table>
        <tr>
          <th scope="col" id="t1">Projects</th>
  ...
  it('should work with tables that have inconsistent columns', () => {
    fixture.innerHTML = html`
      <table>
        <tr>
          <td id="t1">t1</td>
  ...
  it('should handle multiple headers with colspan', () => {
    fixture.innerHTML = html`
      <table>
      <thead>
      <tr>
  ...
  it('should handle multiple headers with rowspan', () => {
    fixture.innerHTML = html`
      <table>
      <tbody>
      <tr>
  ...
  it('should handle negative colspan', () => {
    fixture.innerHTML = html`
      <table>
      <thead>
      <tr>
  ...
  it('should handle negative rowspan', () => {
    fixture.innerHTML = html`
      <table>
      <tbody>
      <tr>
