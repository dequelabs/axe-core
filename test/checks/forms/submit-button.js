describe('submit-button', function() {
  ...
  it('should return undefined as form only contains textareas', function() {
  ...
  it('should return undefined as form has button that is disabled', function() {
    var params = checkSetup(
  ...
  it('should return undefined as form has input with submit and disabled', function() {
    var params = checkSetup(
