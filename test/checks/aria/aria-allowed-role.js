describe('aria-allowed-role', function () {
  ...
  it('returns true when img has no alt and role="presentation"', function () {
    let vNode = queryFixture('<img id="target" role="presentation"/>');
    assert.isTrue(
      axe.testUtils
        .getCheckEvaluate('aria-allowed-role')
        .call(checkContext, null, null, vNode)
  ...
  it('returns true when img has no alt and role="none"', function () {
    let vNode = queryFixture('<img id="target" role="none"/>');
    assert.isTrue(
      axe.testUtils
        .getCheckEvaluate('aria-allowed-role')
        .call(checkContext, null, null, vNode)
  ...
  it('returns true when img has empty alt and role="presentation"', function () {
    let vNode = queryFixture('<img id="target" alt="" role="presentation"/>');
    assert.isTrue(
      axe.testUtils
        .getCheckEvaluate('aria-allowed-role')
        .call(checkContext, null, null, vNode)
  ...
  it('returns true when img has empty alt and role="none"', function () {
    let vNode = queryFixture('<img id="target" alt="" role="none"/>');
    assert.isTrue(
      axe.testUtils
        .getCheckEvaluate('aria-allowed-role')
        .call(checkContext, null, null, vNode)
  ...
  it('returns false when img has alt and role="none"', function () {
    let vNode = queryFixture('<img id="target" alt="not empty" role="none"/>');
    assert.isFalse(
      axe.testUtils
        .getCheckEvaluate('aria-allowed-role')
        .call(checkContext, null, null, vNode)
  ...
  it('returns true when input of type image and no role', function () {
    let vNode = queryFixture('<input id="target" type="image"/>');
    assert.isTrue(
      axe.testUtils
        .getCheckEvaluate('aria-allowed-role')
        .call(checkContext, null, null, vNode)
  ...
  it('returns true when INPUT type is text with role combobox', function () {
    let vNode = queryFixture('<input id="target" type="text" role="combobox">');
    assert.isTrue(
      axe.testUtils
        .getCheckEvaluate('aria-allowed-role')
        .call(checkContext, null, null, vNode)
  ...
  it('returns true when INPUT type is tel with role combobox', function () {
    let vNode = queryFixture('<input id="target" type="tel" role="combobox">');
    assert.isTrue(
      axe.testUtils
        .getCheckEvaluate('aria-allowed-role')
        .call(checkContext, null, null, vNode)
  ...
  it('returns true when INPUT type is url with role combobox', function () {
    let vNode = queryFixture('<input id="target" type="url" role="combobox">');
    assert.isTrue(
      axe.testUtils
        .getCheckEvaluate('aria-allowed-role')
        .call(checkContext, null, null, vNode)
  ...
  it('returns false when a role is set on an element that does not allow any role', function () {
    let vNode = queryFixture('<dd id="target" role="link">');
    assert.isFalse(
      axe.testUtils
        .getCheckEvaluate('aria-allowed-role')
        .call(checkContext, null, null, vNode)
  ...
  it('returns true when a role is set on an element that can have any role', function () {
    let vNode = queryFixture('<div id="target" role="link"></dd>');
    assert.isTrue(
      axe.testUtils
        .getCheckEvaluate('aria-allowed-role')
        .call(checkContext, null, null, vNode)
  ...
  it('returns true an <a> without a href to have any role', function () {
    let vNode = queryFixture('<a id="target" role="presentation"></a>');
    assert.isTrue(
      axe.testUtils
        .getCheckEvaluate('aria-allowed-role')
        .call(checkContext, null, null, vNode)
  ...
  it('returns true <a> with a empty href to have any valid role', function () {
    let vNode = queryFixture('<a id="target" role="link" href=""></a>');
    let actual = axe.testUtils
      .getCheckEvaluate('aria-allowed-role')
      .call(checkContext, null, null, vNode);
  ...
  it('returns true <img> with a non-empty alt', function () {
    let vNode = queryFixture('<img id="target" role="button" alt="some text">');
    assert.isTrue(
      axe.testUtils
        .getCheckEvaluate('aria-allowed-role')
        .call(checkContext, null, null, vNode)
  ...
  it('should allow <select> without a multiple and size attribute to have a menu role', function () {
    let vNode = queryFixture('<select id="target" role="menu">');
    assert.isTrue(
      axe.testUtils
        .getCheckEvaluate('aria-allowed-role')
        .call(checkContext, null, null, vNode)
  ...
  it('returns true custom element <my-navbar> with a role of navigation', function () {
    let vNode = queryFixture('<my-navbar id="target" role="navigation">');
    let actual = axe.testUtils
      .getCheckEvaluate('aria-allowed-role')
      .call(checkContext, null, null, vNode);
    assert.isTrue(actual);
  ...
  it('returns false if a dpub role’s type is not the element’s implicit role', function () {
    let vNode = queryFixture('<article id="target" role="doc-biblioref">');
    assert.isFalse(
      axe.testUtils
        .getCheckEvaluate('aria-allowed-role')
        .call(checkContext, null, null, vNode)
  ...
  it('returns true if a dpub role’s type is the element’s implicit role', function () {
    let vNode = queryFixture('<a id="target" href="foo" role="doc-biblioref">');
    assert.isTrue(
      axe.testUtils
        .getCheckEvaluate('aria-allowed-role')
        .call(checkContext, null, null, vNode)
