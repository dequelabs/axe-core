        ...
        it('returns true if the widget is not tabbable', () => {
          const checkArgs = checkSetup(
            html`<a
              ...
              id="target"
            >
              <button tabindex="-1" style="margin:1px; line-height:20px">
                Play
              </button>
            </a>`
          );
      ...
      it('is undefined when unobscured area is too small', () => {
        const checkArgs = checkSetup(html`
          <a href="#" id="target" style="font-size:24px;">
            <img width="24" height="36" style="vertical-align: bottom;" /> </a
          ><br />
          <a href="" style="margin-top:-10px; position:absolute; width:24px;"
            >&nbsp;</a
          >
        `);
        assert.isUndefined(check.evaluate.apply(checkContext, checkArgs));
      ...
      it('is true when unobscured area is sufficient', () => {
        const checkArgs = checkSetup(html`
          <a href="#" id="target" style="font-size:24px;">
            <img width="24" height="36" style="vertical-align: bottom;" /> </a
          ><br />
          <a href="" style="margin-top:-2px; position:absolute; width:24px;"
            >&nbsp;</a
          >
        `);
        assert.isTrue(check.evaluate.apply(checkContext, checkArgs));
    ...
    describe('and fully obscured', () => {
      it('is undefined', () => {
        const checkArgs = checkSetup(html`
          ...
          <a
            href=""
            style="margin-top:-40px; position:absolute; width:100px; height:100px;"
            >&nbsp;</a
          >
        `);
        assert.isUndefined(check.evaluate.apply(checkContext, checkArgs));
