describe('duplicate-id-misc matches', () => {
  ...
  it('returns true if the ID is of an inactive non-referenced element', () => {
  ...
  it('returns true if the ID is of an inactive non-referenced element with a duplicate', () => {
  ...
  it('returns false if the ID is of an inactive ARIA referenced element', () => {
    fixtureSetup(html`
      <div id="foo"></div>
  ...
  it('returns false if the ID is a duplicate of an inactive ARIA referenced element', () => {
    fixtureSetup(html`
      <div id="foo"></div>
      <div aria-labelledby="foo"></div>
      <span id="foo"></span>
  ...
  it('returns false if the ID is of an active ARIA referenced element', () => {
    fixtureSetup(html`
      <button id="foo"></button>
      <div aria-labelledby="foo"></div>
    `);
  ...
  it('returns false if the ID is a duplicate of of an active ARIA referenced element', () => {
    fixtureSetup(html`
      <button id="foo"></button>
      <div aria-labelledby="foo"></div>
      <span id="foo"></span>
