describe('identical-links-same-purpose-matches tests', () => {
  ...
  it('returns false when native link without accessible name', () => {
    const vNode = queryFixture('<a id="target" href=""></a>');
    const actual = rule.matches(vNode.actualNode, vNode);
    assert.isFalse(actual);
  });

  it('returns false for ARIA link without accessible name', () => {
    const vNode = queryFixture('<span role="link" id="target"></span>');
    const actual = rule.matches(vNode.actualNode, vNode);
    assert.isFalse(actual);
  });

  it('returns false for native link with a role !== link', () => {
  ...
  it('returns false when `area` has no parent `map` element', () => {
    const vNode = queryFixture(
  ...
  it('returns false when `area` has parent `map` that is not referred by `img[usemap]`', () => {
  ...
  it('returns true when native link without href', () => {
    const vNode = queryFixture('<a id="target">Book Now</a>');
    const actual = rule.matches(vNode.actualNode, vNode);
    assert.isTrue(actual);
  });

  it('returns true when ARIA link without href', () => {
    const vNode = queryFixture(
  ...
  it('returns true when native link has an accessible name', () => {
    const vNode = queryFixture(
  ...
  it('returns true for ARIA link has an accessible name', () => {
    const vNode = queryFixture(
  ...
  it('returns true when `area` has parent `map` that is referred by `img`', () => {
    const vNode = queryFixture(html`
