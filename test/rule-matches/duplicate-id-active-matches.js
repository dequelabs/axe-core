describe('duplicate-id-active matches', () => {
  ...
  it('returns true if the ID is of an active non-referenced element', () => {
  ...
  it('returns true if the ID is a duplicate of an active non-referenced element', () => {
    fixtureSetup(html`
      <div id="foo"></div>
