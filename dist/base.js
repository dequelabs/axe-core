var base = (function(exports) {
	...
	*/
	 ...
	 * @type {Boolean}
	 */
	Check$1.prototype.enabled = true;
	 ...
	 */
	Check$1.prototype.run = function(node, options, context, resolve, reject) {
		options = options || {};
		...
		if (enabled) {
			...
			var checkHelper = checkHelper(checkResult, options, resolve, reject);
			var result;
	 ...
	 *                             information for the check
	 */
	Check$1.prototype.runSync = function(node, options, context) {
		options = options || {};
		...
		const checkHelper = checkHelper(checkResult, options);
	...
	Check$1.prototype.configure = function(spec) {
		['options', 'enabled']
	...
	function Rule$1(spec, parentAudit) {
	 ...
	 */
	Rule$1.prototype.matches = function() {
		return true;
	};
	 ...
	 */
	Rule$1.prototype.gather = function(context, options = {}) {
	...
	Rule$1.prototype.runChecks = function(
		type,
		node,
		options,
		context,
	 ...
	 */
	Rule$1.prototype.runChecksSync = function(type, node, options, context) {
		const self = this;
		let results = [];
	 ...
	 */
	Rule$1.prototype.run = function(context, options = {}, resolve, reject) {
		if (options.performanceTimer) {
			this._trackPerformance();
		}

		const q = queue();
		const ruleResult = new RuleResult$1(this);
		let nodes;
	 ...
	 * @param  {Mixed}   options  Options specific to this rule
	 */
	Rule$1.prototype.runSync = function(context, options = {}) {
		if (options.performanceTimer) {
			this._trackPerformance();
		}
	 ...
	 * @private
	 */
	Rule$1.prototype._trackPerformance = function() {
	 ...
	 */
	Rule$1.prototype._logGatherPerformance = function(nodes) {
	 ...
	 * @param {Rule} rule The rule to log
	 */
	Rule$1.prototype._logRulePerformance = function() {
	 ...
	 * @return {Array}           All matching `HTMLElement`s
	 */
	Rule$1.prototype.gatherAndMatchNodes = function(context, options) {
	 ...
	 */
	Rule$1.prototype.after = function(result, options) {
	 ...
	 */
	Rule$1.prototype.configure = function(spec) {
	...
	exports.AbstractVirtualNode = AbstractVirtualNode;
	exports.Audit = Audit;
	exports.Check = Check$1;
	exports.CheckResult = CheckResult;
	exports.Context = Context;
	exports.Rule = Rule$1;
	exports.RuleResult = RuleResult$1;
	exports.SerialVirtualNode = SerialVirtualNode;
