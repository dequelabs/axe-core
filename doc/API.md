...
In this example, we pass the selector for the entire document, disable two rules, and have a simple callback function that logs the entire results object to the console log:
