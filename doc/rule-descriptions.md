...
| landmark-at-least-one-main | Each page must have at least one main landmark, used to identify the main content. | cat.keyboard, cat.best-practice | true |
| landmark-no-more-than-one-main | Each page must have no more than one main landmark, used to identify the main content. | cat.keyboard, cat.best-practice | true |
