...
| css-orientation-lock | Ensures that the content is not locked to any specific display orientation, and functionality of the content is operable in all display orientations (portrait/ landscape) | Serious | cat.structure, wcag262, wcag21aa | true |
