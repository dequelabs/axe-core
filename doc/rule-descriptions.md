...
| aria-hidden-body | Ensures aria-hidden is not present on the document body. | cat.aria, wcag2a, wcag411, wcag412 | true |
...
| hidden-content | Informs users about hidden content |  | true |
