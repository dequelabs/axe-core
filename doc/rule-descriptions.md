...
| aria-roles | Ensures all elements with a role attribute use a valid value | Critical | cat.aria, wcag2a, wcag131, wcag411, wcag412 | true |
...
| label | Ensures every form element has a label | Critical | cat.forms, wcag2a, wcag332, wcag131, section508, section508.22.n | true |
...
| scope-attr-valid | Ensures the scope attribute is used correctly on tables | Critical | cat.tables, best-practice | true |
