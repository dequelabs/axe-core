...
Axe comes with a script to help generate rule files. To use this, call `pnpm run rule-gen` from the root of the project. If you haven't already, make sure to call `pnpm install` before to get all dependencies installed first.
